 ...
 * Access to the Application
   * To access the application, please visit http://frontendtest-env.eba-wempu9ue.ca-central-1.elasticbeanstalk.com/ 
   * Since this application is developed as a prototype of an internal tool for the Toronto Transportation Services Big Data Innovation team, there is no user authentication requirement at the current development stage. All users having access to the application are granted same and complete access to features and functionalities
 ...
 * Nodes
   ...
   * Deletion
     ...
     * By clicking the “Reset Map” button at the bottom right corner, you are able to remove all staffs created on the map, including all the nodes
 * Links
   ...
   * Creation
     ...
     * Every link has some arrows to indicate the direction it goes. Regularly, the arrows are single arrows
   ...
   * Deletion
     ...
     * By clicking the “Reset Map” button at the bottom right corner, you are able to remove all staffs created on the map, including all the links
 * Sequences
   ...
   * Deletion
     ...
     * By clicking the “Reset Map” button at the bottom right corner, you can remove all staffs created on the map, including all the sequences
 * Data
   ...
   * Time Specification 
     ...
     * Multiple Time Ranges
       * The application support querying data for multiple time ranges
